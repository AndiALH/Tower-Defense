...
public class Tower : MonoBehaviour
{
    ...
    [SerializeField] private ElementType _bulletElement;
    ...
    public void ShootTarget()
    {
        ...
        if (_runningShootDelay <= 0f)
        {
            ...
            bullet.SetProperties(_shootPower, _bulletSpeed, _bulletSplashRadius, _bulletElement);
...
//Enum untuk menyimpan tipe elemen tower, untuk suatu fitur yang mungkin akan ditambahkan
